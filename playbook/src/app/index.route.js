    ...
    function routeConfig($stateProvider, $urlRouterProvider, $locationProvider)
    {
        ...
        $stateProvider
            .state('app', {
                ...
                views   : {
                    'main@'         : {
                        templateUrl: 'app/core/layouts/vertical-navigation-fullwidth-toolbar.html',
                        controller : 'MainController as vm'
                    },
                    'toolbar@app'   : {
                        templateUrl: 'app/toolbar/layouts/vertical-navigation-fullwidth-toolbar/toolbar.html',
